...
public class UserOptionsTemplateNotification implements DialogInterface.OnClickListener{
	...
	private final CharSequence[] options = new CharSequence[state.getTempFiles().length+1];
	@Override
	public void onClick(DialogInterface arg0, int arg1) {
		...
		case 1: 
			...
			FRAGUEL.getInstance().createDialog("Nueva ruta: mediante captura de puntos", options, new GeoTaggingButton(), null);
			break;
